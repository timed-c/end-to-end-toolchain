...
for ((i=1; i<=$tsk; i=i+1))
    do
        ...
        ssh pi@10.42.0.101 "cd && cd /home/pi/Documents/rtss/ && sudo ./$exe $k $iter"
        #ssh pi@10.42.0.101 "scp *.ktc.trace saranya@10.42.0.1:/home/saranya/Dokument/e2e/rtss/$exp && rm $exe && ./clean.sh && exit"
        #cp *.ktc.trace $dir
        #cp *.ktc.trace traces
        #cp $file $dir
        #pout="${var}_${i}.perf"
