...
# 5 "test1.c" 2
# 1 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 1
...
# 4 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 5 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
# 1 "/usr/include/time.h" 1 3 4
...
# 6 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 7 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 8 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 9 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 12 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stdbool.h" 1 3 4
# 14 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
# 1 "/usr/include/linux/sched.h" 1 3 4
# 15 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 16 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 21 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
enum sched_policy{EDF, FIFO_RM, RR_RM, FIFO_DM, RR_DM};
int policy = 0;
extern int setschedvar;
# 44 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
extern int period;
extern int runtime;
extern int deadline;
...
# 73 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
...
# 104 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 3 4
_Bool 
...
struct sched_attr {
 ...
 __u32 
# 150 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 3 4
      __sched_priority
# 150 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
                    ;
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ , __leaf__));
# 172 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 2
...
# 183 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
static inline int getoptdummy()
{
  int i;
  optarg = 
# 186 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 3 4
          ((void *)0)
# 186 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
              ;
  sscanf(
# 187 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 3 4
        ((void *)0)
# 187 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
            ,"%d",&i);
  return getopt_long(0, 
# 188 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 3 4
                       ((void *)0)
# 188 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
                           , 
# 188 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h" 3 4
                             ((void *)0)
# 188 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
...
# 214 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
...
double bcd_to_double(void *buf, size_t len,
                      int digits);
int double_to_bcd(double arg, char *buf,
...
void* __attribute__((task)) tsk_foo(){
    int i;
    for(i=0;i<50;i++){
        mrad2deg(50);
        sdelay(30, 30, -3);
...
void* __attribute__((task)) tsk_bar(){
...
void* __attribute__((task)) tsk_far(){
    int i;
    for(i=0; i<50;i++){
         rad2deg(100);
        sdelay(60, 60, -3);
...
int *dummyglobalvariable; int populatelist(int num){ if(num == 0){return 0;} qsort (list_dl, num, sizeof(int), compare_qsort); qsort (list_pr, num, sizeof(int), compare_qsort);return 1; } void main(){
