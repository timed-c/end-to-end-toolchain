#!/bin/bash
name=$1
/home/saranya/Dokument/ktc/bin/ktc --enable-ext2 --save-temps $name -L. -llogs -lmbench  -w --link -g
./a.out
/home/saranya/Dokument/ktc/bin/ktc --enable-ext3 --save-temps $name -L. -llogs -lmbench -w --link -g
